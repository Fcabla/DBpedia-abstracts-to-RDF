...
Adapted for python3 by: Fernando Casabán Blasco
    Added decorator @Language.component('extract_clauses_doc') line: 404
    Added quotes nlp.add_pipe('extract_clauses_doc') line:414
    Changed patters -> List[Dict[str, Any]] to List[List[Dict[str, Any]]] lines:308-312
    Added new method to construct nlp and return it instead of a main funct
...
def _get_verb_matches(span):
    ...
    verb_matcher.add(
        "Auxiliary verb phrase aux-verb", [[{"POS": "AUX"}, {"POS": "VERB"}]], on_match=None
    )
    verb_matcher.add("Auxiliary verb phrase", [[{"POS": "AUX"}]], on_match=None)
    verb_matcher.add("Verb phrase", [[{"POS": "VERB"}]], on_match=None)
